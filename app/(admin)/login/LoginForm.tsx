    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 className="t-heading" style={{ marginBottom: 8 }}>Staff Login</h1>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <button
              ...
              style={{
                ...
                color: 'var(--cream-35)', cursor: 'pointer',
        ...
        {error && <p className="nn-error" style={{ marginBottom: 16 }}>{error}</p>}

        <p className="nn-hint" style={{ marginBottom: 28 }}>
          Restaurant staff accounts are created by your NovaNode administrator.
        </p>
