      ...
      >
        ...
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "24px 20px" }}>
            ...
            >
              {uploadingImage ? (
                ...
                <>
                  ...
                  >
                    <p className="t-caption" style={{ color: "#fff" }}>
                      Click to change
                    </p>
                  </div>
                </>
          ...
          >
            ...
            <div>
              {!form.name_fr && !form.description_fr && form.name_en && (
                <button
                  type="button"
                  onClick={handleAutoTranslate}
                  disabled={isTranslating}
                  className="w-full mb-3 py-2 px-4 rounded-lg border border-amber-500/40 bg-amber-500/10 text-amber-300 text-sm font-medium flex items-center justify-center gap-2 hover:bg-amber-500/20 transition-colors disabled:opacity-50"
                >
                  {isTranslating ? (
                    <>
                    ...
                    <>
                      <span>🌐</span>
                      <span>Auto-translate to French</span>
                    </>
                  )}
                </button>
              )}
          ...
          <button className="btn-primary" onClick={saveItem} disabled={saving}>
            {saving ? (
              ...
              <>
                <Check size={18} />{" "}
                {view === "edit-item" ? "Update Item" : "Add to Menu"}
              </>
            )}
          </button>
        </div>
  ...
  if (view === "add-category") {
    return (
      ...
      >
        <header className="dash-header">
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button className="btn-icon" onClick={() => setView("list")}>
              <ChevronLeft size={18} />
            </button>
            <div>
              <p className="t-title" style={{ fontSize: 15 }}>
        ...
        <div style={{ maxWidth: 500, margin: "0 auto", padding: "32px 20px" }}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              value={catName.en}
              onChange={(e) =>
                setCatName((c) => ({ ...c, en: e.target.value }))
              }
              autoFocus
            />
          </div>
          <div style={{ marginBottom: 32 }}>
            ...
            <input
              ...
              value={catName.fr}
              onChange={(e) =>
                setCatName((c) => ({ ...c, fr: e.target.value }))
              }
            />
          </div>
          <button
    ...
    >
      <header className="dash-header">
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <button
            className="btn-icon"
            onClick={() => router.push(`/dashboard/${restaurant.slug}`)}
          >
            <ChevronLeft size={18} />
          </button>
          <div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "20px 16px" }}>
        ...
        {filteredItems.length === 0 ? (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            ...
            <button
              className="btn-primary"
              style={{ width: "auto", margin: "0 auto", display: "flex" }}
              onClick={openAddItem}
            >
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    {item.is_starter && (
                      <Zap size={12} color="var(--gold-glow)" />
                    )}
                    {!item.is_available && (
                      <span
                        style={{
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor: "pointer",
                      color: item.is_available ? "#34d399" : "var(--cream-35)",
                      padding: 6,
                      display: "flex",
                      transition: "all 0.2s",
                    }}
